(function() {
  ...
  var TopMenu = React.createClass({displayName: "TopMenu",
    render: function () {
      return (
        React.createElement(Menu, {className: "secondary pointing"}, 
          React.createElement(Item, {className: "right active", type: "link"}, "首頁"), 
          React.createElement(Item, {className: "right", type: "link"}, "營期資訊"), 
          React.createElement(Item, {className: "right dropdown", type: "link"}, "歡迎新生", 
          ...
          React.createElement(Item, {className: "right", type: "link"}, "新生須知"), 
          React.createElement(Item, {className: "right", type: "link"}, "學校資源")
        )
      );
    }
  });
